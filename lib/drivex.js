...
DriveX.prototype = {
  ...
  waitForElementVisible: function (locator, timeout, msg) {
    ...
    return this.driver.wait(this.wd.until.elementIsVisible(this.driver.findElement(this.by(locator))), timeout, msg).then(function() {
      log('waitForElementVisible: found', locator);
      return true;
    }, function(err) {
